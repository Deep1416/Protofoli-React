...
const Header = () => {
  ...
  return (
    <motion.nav
      id="nav"
      className={`md:top-0 md:fixed fixed top-0 left-0 right-0 z-50 flex flex-col md:flex-row self-center justify-between md:px-14 pb-1 text-white ${
          ...
          {showSocialHandles && (
            ...
            >
              ...
              <div className=" p-2 flex item-center self-center-2xl hover:bg-[#111827]  rounded-lg ">
                ...
                <a
                  className="text-center self-center ml-1 font-Pacifico p-1"
                  href="https://x.com/Deep_Rajput1416"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Twitter
