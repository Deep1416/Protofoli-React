  ...
  const projects = [
    {
      ...
      technology: [techReact, techtailwind],
    },
    {
      title: "CodePen",
      description:
    ...
    },
    {
      ...
      goLive: "https://physical-react.vercel.app",
      technology: [techReact, techtailwind],
    },
    {
    ...
    },
    {
      ...
      technology: [techHtml, techCSS, techJs],
    },
    {
      title: "Drum Kit",
      description:
              ...
              <div className="my-3 font-Josefin text-2xl font-semibold leading-snug text-white flex items-center justify-between">
                ...
                <div className="flex items-center">
                  {project.technology.map((item, idx) => (
                    <img src={item} key={idx} className="w-10 h-10" alt="" />
                  ))}
                </div>
              </div>
